  ...
  <Box mx={{base:0, sm:2, md:3, lg:20}} >
    ...
    _before={{
      ...
      <Box left={-2} position={"absolute"} w={5} h={5} 
        ...
        <Stack _hover={{bg:"blackAlpha.500", cursor :'pointer',}} p={{base:3, sm:3, md:3, lg:50}} boxShadow="lg"  rounded={3}
         marginBottom={"0"} 
    ...
    <Stack _hover={{bg:"blackAlpha.500",cursor :'pointer',}} p={{base:3, sm:3, md:3,lg:50}} rounded={3} my={4} py={4} boxShadow="lg"  marginBottom={"0"} px={2} pt={5} maxH={"full"} display={'flex'}>
    ...
    <Stack _hover={{bg:"blackAlpha.500", cursor :'pointer',}}  p={{base:3, sm:3, md:3,lg:50}} rounded={3} boxShadow="lg"  px={2} my={4} py={4} 
